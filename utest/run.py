...
"""Helper script to run all Robot Framework SSHLibray unit tests.
...
Note: If calling from Jython, use:
      CLASSPATH=$CLASSPATH:<source_path>/lib/trilead-ssh2-1.0.0-build217.jar \
      jython utest/run.py
"""
